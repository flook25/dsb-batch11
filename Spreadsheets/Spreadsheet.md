...
- Enriching Data with `VLOOKUP`  
- Working with Dates & Text (Strings)  
- Regular Expressions  
- Sparkline Basics

**Mini Projects:**  
- 🔄 [Dynamic Query](https://docs.google.com/spreadsheets/d/1lg1INdLBKaa5sX0ZALAAvQzmJvKSgLNovgjsU-feJTk/edit?usp=sharing)  
- 🗓️ [Convert TH to EN Date](https://docs.google.com/spreadsheets/d/1sPy1-dplqp2fVpUtAXpUm8bxUhsdcx-To4qHvxjQjrk/edit?usp=sharing)  
